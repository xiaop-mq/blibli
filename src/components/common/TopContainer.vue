    ...
    <div class="z_top b-header-blur b-header-blur-black">
      <div class="b-header-mask-wrp">
        <div
          ...
          style="background-image: url(//i0.hdslb.com/bfs/archive/ed92db305ae43c7fc8a59b1789934caa2636b876.png);"
        ></div>
      ...
      <div class="z_header">
        <div class="z_top_nav">
          <ul>
            ...
            <li class="manga" hasframe="true">
              <a class="i-link" target="_blank" href="//manga.bilibili.com/" title="漫画">漫画</a>
            </li>
            <li class="b-zb">
